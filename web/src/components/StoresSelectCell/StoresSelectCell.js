  ...
  return (
    <div className="mb-4">
      ...
      <select
        ...
        id="stores"
        className="text-2xl bg-white shadow-lg px-4 py-2 rounded mt-1 form-select block w-full pl-3 pr-10 leading-6 border-gray-300 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
        {stores.map(store => {
